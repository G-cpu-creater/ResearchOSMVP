...
export default function DashboardLayout({
  ...
  // Check if user is inside a specific project view
  const isInsideProject = () => {
    if (!pathname) return false
    
    // Match pattern: /projects/[id] but exclude /projects and /projects/new
    ...
    return isProjectDetail && !isNewProject
  }

  const shouldShowSidebar = !isInsideProject()
